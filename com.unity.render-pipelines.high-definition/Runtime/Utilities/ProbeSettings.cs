...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public struct ProbeSettings
    {
        ...
        public struct Lighting
        {
            ...
            [Obsolete("Since 2020.1, use Lighting.NewDefault() instead.")]
        ...
        {
            /// <summary>Default value.</summary>
            [Obsolete("Since 2020.1, use ProxySettings.NewDefault() instead.")]
        ...
        /// <summary>Default value.</summary>
        [Obsolete("Since 2020.1, use ProbeSettings.NewDefault() instead.")]
